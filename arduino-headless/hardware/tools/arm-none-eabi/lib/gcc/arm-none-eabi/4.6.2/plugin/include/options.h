...
enum opt_code
{
  ...
  OPT_mabi_ = 941,                           /* -mabi= */
  OPT_mabort_on_noreturn = 942,              /* -mabort-on-noreturn */
  OPT_mapcs = 943,                           /* -mapcs */
  OPT_mapcs_float = 944,                     /* -mapcs-float */
  OPT_mapcs_frame = 945,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 946,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 947,               /* -mapcs-stack-check */
  OPT_march_ = 948,                          /* -march= */
  OPT_marm = 949,                            /* -marm */
  OPT_mbig_endian = 950,                     /* -mbig-endian */
  OPT_mcallee_super_interworking = 951,      /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 952,      /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 953,       /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 954,                           /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 955,             /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 956,                     /* -mfloat-abi= */
  OPT_mfp16_format_ = 957,                   /* -mfp16-format= */
  OPT_mfp_ = 958,                            /* -mfp= */
  OPT_mfpe = 959,                            /* -mfpe */
  OPT_mfpe_ = 960,                           /* -mfpe= */
  OPT_mfpu_ = 961,                           /* -mfpu= */
  OPT_mhard_float = 962,                     /* -mhard-float */
  OPT_mlittle_endian = 963,                  /* -mlittle-endian */
  OPT_mlong_calls = 964,                     /* -mlong-calls */
  OPT_mpic_register_ = 965,                  /* -mpic-register= */
  OPT_mpoke_function_name = 966,             /* -mpoke-function-name */
  OPT_msched_prolog = 967,                   /* -msched-prolog */
  OPT_msingle_pic_base = 968,                /* -msingle-pic-base */
  OPT_msoft_float = 969,                     /* -msoft-float */
  OPT_mstructure_size_boundary_ = 970,       /* -mstructure-size-boundary= */
  OPT_mthumb = 971,                          /* -mthumb */
  OPT_mthumb_interwork = 972,                /* -mthumb-interwork */
  OPT_mtp_ = 973,                            /* -mtp= */
  OPT_mtpcs_frame = 974,                     /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 975,                /* -mtpcs-leaf-frame */
  OPT_mtune_ = 976,                          /* -mtune= */
  OPT_munaligned_access = 977,               /* -munaligned-access */
  OPT_mvectorize_with_neon_quad = 978,       /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 979,               /* -mword-relocations */
  OPT_mwords_little_endian = 980,            /* -mwords-little-endian */
  OPT_n = 981,                               /* -n */
  OPT_no_canonical_prefixes = 982,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 983,               /* -no-integrated-cpp */
  OPT_nocpp = 984,                           /* -nocpp */
  OPT_nodefaultlibs = 985,                   /* -nodefaultlibs */
  OPT_nostartfiles = 986,                    /* -nostartfiles */
  OPT_nostdinc = 987,                        /* -nostdinc */
  OPT_nostdinc__ = 988,                      /* -nostdinc++ */
  OPT_nostdlib = 989,                        /* -nostdlib */
  OPT_o = 990,                               /* -o */
  OPT_p = 991,                               /* -p */
  OPT_pass_exit_codes = 992,                 /* -pass-exit-codes */
  OPT_pedantic = 993,                        /* -pedantic */
  OPT_pedantic_errors = 994,                 /* -pedantic-errors */
  OPT_pg = 995,                              /* -pg */
  OPT_pie = 996,                             /* -pie */
  OPT_pipe = 997,                            /* -pipe */
  ...
  OPT_quiet = 1008,                          /* -quiet */
  OPT_r = 1009,                              /* -r */
  OPT_remap = 1010,                          /* -remap */
  OPT_s = 1011,                              /* -s */
  OPT_s_bc_abi = 1012,                       /* -s-bc-abi */
  OPT_save_temps = 1013,                     /* -save-temps */
  OPT_save_temps_ = 1014,                    /* -save-temps= */
  OPT_shared = 1015,                         /* -shared */
  OPT_shared_libgcc = 1016,                  /* -shared-libgcc */
  /* OPT_specs = 1017, */                    /* -specs */
  OPT_specs_ = 1018,                         /* -specs= */
  OPT_static = 1019,                         /* -static */
  OPT_static_libgcc = 1020,                  /* -static-libgcc */
  OPT_static_libgcj = 1021,                  /* -static-libgcj */
  OPT_static_libgfortran = 1022,             /* -static-libgfortran */
  OPT_static_libgo = 1023,                   /* -static-libgo */
  OPT_static_libstdc__ = 1024,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1025, */                /* -std=c++03 */
  OPT_std_c__0x = 1026,                      /* -std=c++0x */
  OPT_std_c__98 = 1027,                      /* -std=c++98 */
  OPT_std_c1x = 1028,                        /* -std=c1x */
  /* OPT_std_c89 = 1029, */                  /* -std=c89 */
  OPT_std_c90 = 1030,                        /* -std=c90 */
  OPT_std_c99 = 1031,                        /* -std=c99 */
  /* OPT_std_c9x = 1032, */                  /* -std=c9x */
  OPT_std_f2003 = 1033,                      /* -std=f2003 */
  OPT_std_f2008 = 1034,                      /* -std=f2008 */
  OPT_std_f95 = 1035,                        /* -std=f95 */
  OPT_std_gnu = 1036,                        /* -std=gnu */
  OPT_std_gnu__0x = 1037,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1038,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1039,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1040, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1041,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1042,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1043, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1044, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1045,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1046, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1047, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1048,                     /* -std=legacy */
  OPT_symbolic = 1049,                       /* -symbolic */
  OPT_t = 1050,                              /* -t */
  OPT_time = 1051,                           /* -time */
  OPT_time_ = 1052,                          /* -time= */
  OPT_traditional = 1053,                    /* -traditional */
  OPT_traditional_cpp = 1054,                /* -traditional-cpp */
  OPT_trigraphs = 1055,                      /* -trigraphs */
  OPT_u = 1056,                              /* -u */
  OPT_undef = 1057,                          /* -undef */
  OPT_v = 1058,                              /* -v */
  OPT_version = 1059,                        /* -version */
  OPT_w = 1060,                              /* -w */
  OPT_wrapper = 1061,                        /* -wrapper */
  OPT_x = 1062,                              /* -x */
  OPT_z = 1063,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
